...
@Getter
@Setter
@Schema(description = "Payload used to create a new conference hall")
public class CreateConferenceHallDTO {
    ...
    @Schema(description = "ID of the building this hall belongs to")
    ...
    public ConferenceHall toEntity(Building building) {
