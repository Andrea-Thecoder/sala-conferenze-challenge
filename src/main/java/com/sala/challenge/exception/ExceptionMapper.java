    ...
    public RestResponse<ExceptionResponse> mapForbiddenException(ForbiddenException ex) {
        ...
        return RestResponse.ResponseBuilder
                .create(Status.FORBIDDEN,
                        new ExceptionResponse(Status.FORBIDDEN.getStatusCode(), "FORBIDDEN", message))
                .type(MediaType.APPLICATION_JSON_TYPE)
                .build();
    }

    @ServerExceptionMapper
    public RestResponse<ExceptionResponse> mapConstraintViolationException(ConstraintViolationException ex) {
        ...
        return RestResponse.ResponseBuilder
                .create(Status.BAD_REQUEST,
                        new ExceptionResponse(Status.BAD_REQUEST.getStatusCode(), "BAD_REQUEST", message))
                .type(MediaType.APPLICATION_JSON_TYPE)
                .build();
    }
